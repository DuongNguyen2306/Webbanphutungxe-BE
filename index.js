...
const partCategoryPublic = require('./routes/partCategoryPublic')
...
app.use('/api/part-categories', partCategoryPublic)
...
app.use('/api/admin/articles', authRequired, adminOrStaffRequired, articleRoutes)
app.use('/api/admin/article', authRequired, adminOrStaffRequired, articleRoutes)
app.use('/api/admin/content/articles', authRequired, adminOrStaffRequired, articleRoutes)
app.use('/api/admin/content/article', authRequired, adminOrStaffRequired, articleRoutes)
app.use('/api/admin/banners', authRequired, adminOrStaffRequired, bannerRoutes)
app.use('/api/wishlist', wishlistRoutes)
app.use('/api/cart', cartRoutes)
app.use('/api/orders', orderRoutes)
app.use('/api/admin', authRequired, adminOrStaffRequired, adminRoutes)
