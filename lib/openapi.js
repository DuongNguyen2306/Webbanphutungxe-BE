        ...
        AdminProductBody: {
          ...
          properties: {
            ...
            attributes: {
              type: 'array',
              description:
                'Danh sách thuộc tính biến thể, ví dụ Màu sắc/Chân ren. BE sẽ sinh tổ hợp Cartesian.',
              items: {
                type: 'object',
                properties: {
                  name: { type: 'string' },
            ...
            variants: {
              type: 'array',
              description:
                'Mỗi phần tử có key duy nhất, attributeValues và các trường giá/tồn kho riêng.',
              items: {
                type: 'object',
                properties: {
                  _id: { type: 'string' },
