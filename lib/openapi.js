      ...
      schemas: {
        ...
        ArticleBody: {
          ...
          properties: {
            ...
            type: { type: 'string', enum: ['intro', 'guide'] },
            author: { type: 'string' },
          },
        },
        BannerBody: {
    ...
    paths: {
      ...
      '/api/articles': {
        get: {
          ...
          description:
            'type=intro trả về 1 bài mới nhất hoặc null; type=guide trả về mảng guide; không truyền type thì trả toàn bộ.',
          parameters: [
            {
              name: 'type',
              in: 'query',
              schema: { type: 'string', enum: ['intro', 'guide'] },
            },
          ],
